...
CREATE TABLE `blood_bags` (
  ...
  CONSTRAINT `blood_bags_ibfk_1` FOREIGN KEY (`donor_id_fk`) REFERENCES `donors` (`donor_id`),
  CONSTRAINT `blood_bags_ibfk_2` FOREIGN KEY (`bank_id_fk`) REFERENCES `blood_banks` (`bank_id`)
