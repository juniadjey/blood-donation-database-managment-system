...
CREATE TABLE `participated_staff` (
  `staff_id_fk` int DEFAULT NULL,
  `compaign_no_fk` int DEFAULT NULL,
  KEY `staff_id_fk` (`staff_id_fk`),
  KEY `compaign_no_fk` (`compaign_no_fk`),
  CONSTRAINT `participated_staff_ibfk_1` FOREIGN KEY (`staff_id_fk`) REFERENCES `staff_members` (`staff_id`),
  CONSTRAINT `participated_staff_ibfk_2` FOREIGN KEY (`compaign_no_fk`) REFERENCES `compaigns` (`compaign_no`)
