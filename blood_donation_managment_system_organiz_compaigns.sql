...
CREATE TABLE `organiz_compaigns` (
  ...
  CONSTRAINT `organiz_compaigns_ibfk_1` FOREIGN KEY (`bank_id_fk`) REFERENCES `blood_banks` (`bank_id`),
  CONSTRAINT `organiz_compaigns_ibfk_2` FOREIGN KEY (`compaign_no_fk`) REFERENCES `compaigns` (`compaign_no`)
